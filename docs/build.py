...
GITHUB = "https://github.com/lovelaced/unstation-android"
DESKTOP_DOCS = "https://lovelaced.github.io/unstation-desktop/"
...
<meta property="og:site_name" content="Unstation for Android">
...
<a class="wordmark" href="index.html"><span class="dot" aria-hidden="true"></span>unstation<span class="wm-tag">android</span></a>
...
<a href="$desktop_docs">Desktop and protocol docs</a>
</div>
</div></nav>
...
<p class="foot-links"><a href="$github" rel="noopener">Source on GitHub</a> &middot; <a href="$desktop_docs">Desktop and protocol docs</a></p>
</div></footer>
</body>
</html>
""")
...
def main():
    ...
    shutil.copytree(HERE / "assets", OUT / "assets")                       # css/js/fonts
    ...
    for i, (src, href, label, desc) in enumerate(PAGES):
        ...
        (OUT / href).write_text(TEMPLATE.substitute(
            title=title, description=desc, github=GITHUB, desktop_docs=DESKTOP_DOCS,
